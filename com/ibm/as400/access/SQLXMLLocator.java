...
/* endif */         
    ...
    public NClob getNClob() throws SQLException
    {
        ...
        {                       //@loch
            ...
            doConversion();     //@loch
            truncated_ = 0; outOfBounds_ = false;      //@loch
            return (NClob) new AS400JDBCNClob(valueClob_, maxLength_); //@loch
        }                       //@loch
        
        return (NClob) new AS400JDBCNClobLocator(new JDLobLocator(locator_), converter_, savedObject_, scale_, true);   //@xml4    
